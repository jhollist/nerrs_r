...
To practice what we have seen today we will be opening and running code inside of a new script.  The script is available on the class repository at [homework/homework_01.R](https://github.com/jhollist/nerrs_r/blob/master/homework/homework_01.R) 

1. Open RStudio
2. Create a new RStudio project and call it "homework_1".
3. Save the R Script from [homework/homework_01.R](https://github.com/jhollist/nerrs_r/blob/master/homework/homework_01.R) to the project you just created.
4. Open the R Script.
5. Run it.
